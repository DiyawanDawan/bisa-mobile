...
mixin _$ProductEntity {
 ...
 String get id; String get name; String? get description; double get pricePerUnit; double? get originalPrice; double get stock; double get minOrder; bool get allowsSample; double get sampleMaxQty; double? get samplePricePerUnit; String get unit; String? get thumbnailUrl; String get biomassaType; String? get grade; String get province; String? get regency; bool get isCertified; bool get isIotMonitored; bool get isEscrowProtected; double get averageRating; int get totalReviews; int get totalSold; String get status; DateTime get createdAt; ProductSellerEntity get seller; ProductTechnicalSpecEntity? get technicalSpec; List<ProductImageEntity>? get images; String get productMode; String? get fertilizerType; bool get isChemicalFree; String? get cropType; String? get categoryId; List<ProductSpecEntity> get specs; String? get videoUrl; bool get isPromoted; DateTime? get promotedUntil; int get promoImpressions; int get promoClicks;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,pricePerUnit,originalPrice,stock,minOrder,allowsSample,sampleMaxQty,samplePricePerUnit,unit,thumbnailUrl,biomassaType,grade,province,regency,isCertified,isIotMonitored,isEscrowProtected,averageRating,totalReviews,totalSold,status,createdAt,seller,technicalSpec,const DeepCollectionEquality().hash(images),productMode,fertilizerType,isChemicalFree,cropType,categoryId,const DeepCollectionEquality().hash(specs),videoUrl,isPromoted,promotedUntil,promoImpressions,promoClicks]);
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  double pricePerUnit,  double? originalPrice,  double stock,  double minOrder,  bool allowsSample,  double sampleMaxQty,  double? samplePricePerUnit,  String unit,  String? thumbnailUrl,  String biomassaType,  String? grade,  String province,  String? regency,  bool isCertified,  bool isIotMonitored,  bool isEscrowProtected,  double averageRating,  int totalReviews,  int totalSold,  String status,  DateTime createdAt,  ProductSellerEntity seller,  ProductTechnicalSpecEntity? technicalSpec,  List<ProductImageEntity>? images,  String productMode,  String? fertilizerType,  bool isChemicalFree,  String? cropType,  String? categoryId,  List<ProductSpecEntity> specs,  String? videoUrl,  bool isPromoted,  DateTime? promotedUntil,  int promoImpressions,  int promoClicks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  double pricePerUnit,  double? originalPrice,  double stock,  double minOrder,  bool allowsSample,  double sampleMaxQty,  double? samplePricePerUnit,  String unit,  String? thumbnailUrl,  String biomassaType,  String? grade,  String province,  String? regency,  bool isCertified,  bool isIotMonitored,  bool isEscrowProtected,  double averageRating,  int totalReviews,  int totalSold,  String status,  DateTime createdAt,  ProductSellerEntity seller,  ProductTechnicalSpecEntity? technicalSpec,  List<ProductImageEntity>? images,  String productMode,  String? fertilizerType,  bool isChemicalFree,  String? cropType,  String? categoryId,  List<ProductSpecEntity> specs,  String? videoUrl,  bool isPromoted,  DateTime? promotedUntil,  int promoImpressions,  int promoClicks)  $default,) {final _that = this;
switch (_that) {
case _ProductEntity():
return $default(_that.id,_that.name,_that.description,_that.pricePerUnit,_that.originalPrice,_that.stock,_that.minOrder,_that.allowsSample,_that.sampleMaxQty,_that.samplePricePerUnit,_that.unit,_that.thumbnailUrl,_that.biomassaType,_that.grade,_that.province,_that.regency,_that.isCertified,_that.isIotMonitored,_that.isEscrowProtected,_that.averageRating,_that.totalReviews,_that.totalSold,_that.status,_that.createdAt,_that.seller,_that.technicalSpec,_that.images,_that.productMode,_that.fertilizerType,_that.isChemicalFree,_that.cropType,_that.categoryId,_that.specs,_that.videoUrl,_that.isPromoted,_that.promotedUntil,_that.promoImpressions,_that.promoClicks);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? description,  double pricePerUnit,  double? originalPrice,  double stock,  double minOrder,  bool allowsSample,  double sampleMaxQty,  double? samplePricePerUnit,  String unit,  String? thumbnailUrl,  String biomassaType,  String? grade,  String province,  String? regency,  bool isCertified,  bool isIotMonitored,  bool isEscrowProtected,  double averageRating,  int totalReviews,  int totalSold,  String status,  DateTime createdAt,  ProductSellerEntity seller,  ProductTechnicalSpecEntity? technicalSpec,  List<ProductImageEntity>? images,  String productMode,  String? fertilizerType,  bool isChemicalFree,  String? cropType,  String? categoryId,  List<ProductSpecEntity> specs,  String? videoUrl,  bool isPromoted,  DateTime? promotedUntil,  int promoImpressions,  int promoClicks)?  $default,) {final _that = this;
switch (_that) {
case _ProductEntity() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.pricePerUnit,_that.originalPrice,_that.stock,_that.minOrder,_that.allowsSample,_that.sampleMaxQty,_that.samplePricePerUnit,_that.unit,_that.thumbnailUrl,_that.biomassaType,_that.grade,_that.province,_that.regency,_that.isCertified,_that.isIotMonitored,_that.isEscrowProtected,_that.averageRating,_that.totalReviews,_that.totalSold,_that.status,_that.createdAt,_that.seller,_that.technicalSpec,_that.images,_that.productMode,_that.fertilizerType,_that.isChemicalFree,_that.cropType,_that.categoryId,_that.specs,_that.videoUrl,_that.isPromoted,_that.promotedUntil,_that.promoImpressions,_that.promoClicks);case _:
  return null;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,pricePerUnit,originalPrice,stock,minOrder,allowsSample,sampleMaxQty,samplePricePerUnit,unit,thumbnailUrl,biomassaType,grade,province,regency,isCertified,isIotMonitored,isEscrowProtected,averageRating,totalReviews,totalSold,status,createdAt,seller,technicalSpec,const DeepCollectionEquality().hash(_images),productMode,fertilizerType,isChemicalFree,cropType,categoryId,const DeepCollectionEquality().hash(_specs),videoUrl,isPromoted,promotedUntil,promoImpressions,promoClicks]);
