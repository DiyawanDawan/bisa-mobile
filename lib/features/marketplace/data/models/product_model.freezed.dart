...
@useResult
$Res call({
 String id, String name, String? description, dynamic pricePerUnit, dynamic originalPrice, dynamic stock, dynamic reservedStock, dynamic availableStock, bool canBook, dynamic minOrder, bool allowsSample, dynamic sampleMaxQty, dynamic samplePricePerUnit, String unit, String? thumbnailUrl, String biomassaType, String? grade, String province, String? regency, bool isCertified, bool isIotMonitored, bool isEscrowProtected, dynamic averageRating, dynamic totalReviews, dynamic totalSold, String? createdAt, ProductSellerModel user, String status, ProductTechnicalSpecModel? technicalSpec, List<ProductImageModel>? images, String productMode, String? fertilizerType, bool isChemicalFree, String? cropType, String availabilityType, String? nextHarvestDate, dynamic nextHarvestQtyTon, int? shelfLifeDays, dynamic landAreaHa, String? categoryId, List<ProductSpecModel> specs, String? videoUrl, bool isPromoted, String? promotedUntil, int promoImpressions, int promoClicks, List<ProductCertificateModel> certificates
});
...
as dynamic,shelfLifeDays: freezed == shelfLifeDays ? _self.shelfLifeDays : shelfLifeDays // ignore: cast_nullable_to_non_nullable
...
@override final  dynamic landAreaHa;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,const DeepCollectionEquality().hash(pricePerUnit),const DeepCollectionEquality().hash(originalPrice),const DeepCollectionEquality().hash(stock),const DeepCollectionEquality().hash(reservedStock),const DeepCollectionEquality().hash(availableStock),canBook,const DeepCollectionEquality().hash(minOrder),allowsSample,const DeepCollectionEquality().hash(sampleMaxQty),const DeepCollectionEquality().hash(samplePricePerUnit),unit,thumbnailUrl,biomassaType,grade,province,regency,isCertified,isIotMonitored,isEscrowProtected,const DeepCollectionEquality().hash(averageRating),const DeepCollectionEquality().hash(totalReviews),const DeepCollectionEquality().hash(totalSold),createdAt,user,status,technicalSpec,const DeepCollectionEquality().hash(_images),productMode,fertilizerType,isChemicalFree,cropType,availabilityType,nextHarvestDate,const DeepCollectionEquality().hash(nextHarvestQtyTon),shelfLifeDays,const DeepCollectionEquality().hash(landAreaHa),categoryId,const DeepCollectionEquality().hash(_specs),videoUrl,isPromoted,promotedUntil,promoImpressions,promoClicks,const DeepCollectionEquality().hash(_certificates)]);
