...
@useResult
$Res call({
 String id, String name, String? description, dynamic pricePerUnit, dynamic originalPrice, dynamic stock, dynamic reservedStock, dynamic availableStock, bool canBook, dynamic minOrder, bool allowsSample, dynamic sampleMaxQty, dynamic samplePricePerUnit, String unit, String? thumbnailUrl, String biomassaType, String? grade, String province, String? regency, bool isCertified, bool isIotMonitored, bool isEscrowProtected, dynamic averageRating, dynamic totalReviews, dynamic totalSold, String? createdAt, ProductSellerModel user, String status, ProductTechnicalSpecModel? technicalSpec, List<ProductImageModel>? images, String productMode, String? fertilizerType, bool isChemicalFree, String? cropType, String availabilityType, String? nextHarvestDate, dynamic nextHarvestQtyTon, String? categoryId, List<ProductSpecModel> specs, String? videoUrl, bool isPromoted, String? promotedUntil, int promoImpressions, int promoClicks, List<ProductCertificateModel> certificates
});
...
as List<ProductCertificateModel>,
  ));
}
/// Create a copy of ProductModel
/// with the given fields replaced by the non-null parameter values.
...
@override@JsonKey() final  int promoClicks;
 final  List<ProductCertificateModel> _certificates;
@override@JsonKey() List<ProductCertificateModel> get certificates {
