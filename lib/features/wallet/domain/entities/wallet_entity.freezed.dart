...
@override
String toString() {
  return 'WalletEntity(id: $id, userId: $userId, balance: $balance, totalEarned: $totalEarned, totalWithdrawn: $totalWithdrawn, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class _WalletEntity implements WalletEntity {
  const _WalletEntity({required this.id, required this.userId, required this.balance, required this.totalEarned, required this.totalWithdrawn, required this.createdAt, required this.updatedAt});
