...
mixin _$OrderModel {
 ...
 String get id; String get orderNumber; String? get checkoutBatchId;@JsonKey(name: 'checkoutBatchNumber') String? get checkoutBatchNumber; String get status; dynamic get totalAmount; dynamic get totalQuantity; dynamic get subtotal; dynamic get platformFee;@JsonKey(name: 'logisticsFee') dynamic get logisticsFee; dynamic get vatAmount; String? get specifications; Map<String, dynamic>? get shippingAddressSnapshot; String get createdAt; List<OrderItemModel> get items; OrderParticipantModel get buyer; OrderParticipantModel get seller; OrderTransactionModel? get transaction; OrderShipmentModel? get shipment; OrderShippingModel? get orderShipping; OrderReviewModel? get review; Map<String, dynamic>? get pendingPayment; Map<String, dynamic>? get dispute; String? get negotiationId;
...
@useResult
$Res call({
 String id, String orderNumber, String? checkoutBatchId,@JsonKey(name: 'checkoutBatchNumber') String? checkoutBatchNumber, String status, dynamic totalAmount, dynamic totalQuantity, dynamic subtotal, dynamic platformFee,@JsonKey(name: 'logisticsFee') dynamic logisticsFee, dynamic vatAmount, String? specifications, Map<String, dynamic>? shippingAddressSnapshot, String createdAt, List<OrderItemModel> items, OrderParticipantModel buyer, OrderParticipantModel seller, OrderTransactionModel? transaction, OrderShipmentModel? shipment, OrderShippingModel? orderShipping, OrderReviewModel? review, Map<String, dynamic>? pendingPayment, Map<String, dynamic>? dispute, String? negotiationId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String orderNumber,  String? checkoutBatchId, @JsonKey(name: 'checkoutBatchNumber')  String? checkoutBatchNumber,  String status,  dynamic totalAmount,  dynamic totalQuantity,  dynamic subtotal,  dynamic platformFee, @JsonKey(name: 'logisticsFee')  dynamic logisticsFee,  dynamic vatAmount,  String? specifications,  Map<String, dynamic>? shippingAddressSnapshot,  String createdAt,  List<OrderItemModel> items,  OrderParticipantModel buyer,  OrderParticipantModel seller,  OrderTransactionModel? transaction,  OrderShipmentModel? shipment,  OrderShippingModel? orderShipping,  OrderReviewModel? review,  Map<String, dynamic>? pendingPayment,  Map<String, dynamic>? dispute,  String? negotiationId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String orderNumber,  String? checkoutBatchId, @JsonKey(name: 'checkoutBatchNumber')  String? checkoutBatchNumber,  String status,  dynamic totalAmount,  dynamic totalQuantity,  dynamic subtotal,  dynamic platformFee, @JsonKey(name: 'logisticsFee')  dynamic logisticsFee,  dynamic vatAmount,  String? specifications,  Map<String, dynamic>? shippingAddressSnapshot,  String createdAt,  List<OrderItemModel> items,  OrderParticipantModel buyer,  OrderParticipantModel seller,  OrderTransactionModel? transaction,  OrderShipmentModel? shipment,  OrderShippingModel? orderShipping,  OrderReviewModel? review,  Map<String, dynamic>? pendingPayment,  Map<String, dynamic>? dispute,  String? negotiationId)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
return $default(_that.id,_that.orderNumber,_that.checkoutBatchId,_that.checkoutBatchNumber,_that.status,_that.totalAmount,_that.totalQuantity,_that.subtotal,_that.platformFee,_that.logisticsFee,_that.vatAmount,_that.specifications,_that.shippingAddressSnapshot,_that.createdAt,_that.items,_that.buyer,_that.seller,_that.transaction,_that.shipment,_that.orderShipping,_that.review,_that.pendingPayment,_that.dispute,_that.negotiationId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String orderNumber,  String? checkoutBatchId, @JsonKey(name: 'checkoutBatchNumber')  String? checkoutBatchNumber,  String status,  dynamic totalAmount,  dynamic totalQuantity,  dynamic subtotal,  dynamic platformFee, @JsonKey(name: 'logisticsFee')  dynamic logisticsFee,  dynamic vatAmount,  String? specifications,  Map<String, dynamic>? shippingAddressSnapshot,  String createdAt,  List<OrderItemModel> items,  OrderParticipantModel buyer,  OrderParticipantModel seller,  OrderTransactionModel? transaction,  OrderShipmentModel? shipment,  OrderShippingModel? orderShipping,  OrderReviewModel? review,  Map<String, dynamic>? pendingPayment,  Map<String, dynamic>? dispute,  String? negotiationId)?  $default,) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
return $default(_that.id,_that.orderNumber,_that.checkoutBatchId,_that.checkoutBatchNumber,_that.status,_that.totalAmount,_that.totalQuantity,_that.subtotal,_that.platformFee,_that.logisticsFee,_that.vatAmount,_that.specifications,_that.shippingAddressSnapshot,_that.createdAt,_that.items,_that.buyer,_that.seller,_that.transaction,_that.shipment,_that.orderShipping,_that.review,_that.pendingPayment,_that.dispute,_that.negotiationId);case _:
  return null;
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderNumber = null,Object? checkoutBatchId = freezed,Object? checkoutBatchNumber = freezed,Object? status = null,Object? totalAmount = freezed,Object? totalQuantity = freezed,Object? subtotal = freezed,Object? platformFee = freezed,Object? logisticsFee = freezed,Object? vatAmount = freezed,Object? specifications = freezed,Object? shippingAddressSnapshot = freezed,Object? createdAt = null,Object? items = null,Object? buyer = null,Object? seller = null,Object? transaction = freezed,Object? shipment = freezed,Object? orderShipping = freezed,Object? review = freezed,Object? pendingPayment = freezed,Object? dispute = freezed,Object? negotiationId = freezed,}) {
