...
@override
String toString() {
  return 'BookingUserEntity(id: $id, fullName: $fullName, avatarUrl: $avatarUrl, companyName: $companyName, isVerified: $isVerified)';
}
...
class _BookingUserEntity implements BookingUserEntity {
  const _BookingUserEntity({required this.id, required this.fullName, this.avatarUrl, this.companyName, this.isVerified = false});
