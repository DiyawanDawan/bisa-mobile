                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          title: Text(
                            'booking.field_delivery_target'.tr(),
                        ...
                        SizedBox(height: AppSpacing.sm),
                        CustomTextField(
                          label: 'booking.field_quantity'.tr(
...
class _HarvestLotOption {
  ...
  bool get isBookable =>
      (status == 'SCHEDULED' || status == 'HARVESTING') &&
      availableQuantityTon > 0;
