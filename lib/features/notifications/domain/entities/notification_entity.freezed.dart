...
mixin _$NotificationEntity {
 ...
 String get id; String get title; String get body; String get type; bool get isRead; String? get refId; String get priority; DateTime get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,title,body,type,isRead,refId,priority,createdAt);

@override
String toString() {
  return 'NotificationEntity(id: $id, title: $title, body: $body, type: $type, isRead: $isRead, refId: $refId, priority: $priority, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String title, String body, String type, bool isRead, String? refId, String priority, DateTime createdAt
});
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? type = null,Object? isRead = null,Object? refId = freezed,Object? priority = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String body,  String type,  bool isRead,  String? refId,  String priority,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.type,_that.isRead,_that.refId,_that.priority,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String body,  String type,  bool isRead,  String? refId,  String priority,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity():
return $default(_that.id,_that.title,_that.body,_that.type,_that.isRead,_that.refId,_that.priority,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String body,  String type,  bool isRead,  String? refId,  String priority,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.type,_that.isRead,_that.refId,_that.priority,_that.createdAt);case _:
  return null;
...
class _NotificationEntity implements NotificationEntity {
  const _NotificationEntity({required this.id, required this.title, required this.body, required this.type, required this.isRead, this.refId, this.priority = 'MEDIUM', required this.createdAt});
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? type = null,Object? isRead = null,Object? refId = freezed,Object? priority = null,Object? createdAt = null,}) {
